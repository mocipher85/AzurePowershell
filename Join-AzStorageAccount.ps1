...
$SubscriptionId = "bhhjgjfhgd"
$ResourceGroupName = "rg-mochpier-fileshares"
$StorageAccountName = "sacloudfileshare"
$SamAccountName = "sacloudfileshare"
$DomainAccountType = "sacloudfileshare" # Default is set as ComputerAccount
...
$OuDistinguishedName = "OU=ACC,OU=Service Accounts,OU=Accounts,DC=ad,DC=mocipher,DC=com"
